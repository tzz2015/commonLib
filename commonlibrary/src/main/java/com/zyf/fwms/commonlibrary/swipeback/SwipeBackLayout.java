package com.zyf.fwms.commonlibrary.swipeback;
...
import com.zyf.fwms.commonlibrary.swipeback.tools.Util;
...
public class SwipeBackLayout extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if(!isCanSwipeBack) return false;
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            return child == mDragContentView&&isCanSwipeBack;
        }
     ...
     * 设置是否可以侧滑返回
     */
    public void setCanSwipeBack(boolean isCanSwipeBack){
        this.isCanSwipeBack=isCanSwipeBack;
    }
